...
feature 'Seller accept proposal and seals the deal' do
    ...
    xscenario 'and send a final offer' do
      ...
      scenario 'buyer accepts and specify the pay methods' do
        ...
        click_on 'Aceitar e continuar'
        choose "Entregar para Rua Urumajo"
        choose('Boleto')
        ...
        expect(page).to have_content 'Colmeia'
        expect(page).to have_content 'Trato feito! Assim que for confirmado o pagamento, o envio será realizado'
         

      end 
      scenario 'buyer changes the delivery address' do
        ...
        click_on 'Chuva gostaria de fechar um acordo com você'
        click_on 'Aceitar e continuar'
        choose "Entregar para outro endereço"
        choose('Cartão de crédito')
        click_on 'Continuar'
        fill_in 'Entregar em', with: 'Rua Bras 31'
        click_on 'Confirmar endereço e selar o trato!'
        
        #assert
        expect(page).to have_content 'Cartão de crédito'
        expect(page).not_to have_content 'Boleto'
        expect(page).not_to have_content('Rua Urumajo', count:2)
        expect(page).to have_content 'Rua Bras 31'
         

      end 
      scenario 'after sealing the deal, its ad vanishes' do
        ...
        fill_in 'Entregar em', with: 'Rua Bras 31'
        click_on 'Confirmar endereço e selar o trato!'
        click_on 'Concluir e voltar para anúncios'
